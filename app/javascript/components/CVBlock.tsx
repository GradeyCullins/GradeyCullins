    ...
    <WideBlockSection>
      <ContentWrapper>
        <div className="flex items-center justify-between mb-4">
          ...
          <a
            href="/cv/download"
            className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-sm"
          >
